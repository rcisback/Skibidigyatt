...
Tab7:AddSlider({
	Name = "Reach Slap Aura (Not work) (Not work)",
	Min = 10,
	Max = 50,
	Default = 25,
	Color = Color3.fromRGB(255,255,255),
...
Tab7:AddDropdown({
	Name = "Slap Aura (Not work) Friend(Not work)",
	Default = "Fight",
	Options = {"Fight", "Not Fight"},
	Callback = function(Value)
...
Tab7:AddDropdown({
	Name = "Slap Aura (Not work) Character",
	Default = "Head",
